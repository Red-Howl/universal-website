...
import { LOCATIONS, SAREE_KINDS, getPriceBands, buildShopUrl, buildTitle, buildDescription, buildContent } from '../../../../../lib/seoLanding';
...
export async function getStaticProps({ params }) {
	...
	const category = 'sarees';
	const style = params.kind;
