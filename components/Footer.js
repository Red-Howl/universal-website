...
export default function Footer({ siteSettings }) {
  return (
    <>
    <style jsx>{`
      .footer { text-align: center; padding: 3rem 1rem; margin-top: 4rem; background-color: #f1f1f1; border-top: 1px solid #e7e7e7; font-family: var(--font-lato); color: #555; }
      .footer-content { max-width: 800px; margin: auto; }
      .social-links { margin-bottom: 1.5rem; }
      .social-links a { margin: 0 1rem; text-decoration: none; color: #333; font-weight: bold; }
    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="copyright">
          <p>© 2025 {siteSettings?.site_name || 'Kalamkar'} by Sowmya. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
    </>
