  ...
  return (
    <>
      <style jsx>{`
        ...
        .logout-btn { background: none; border: none; cursor: pointer; font-family: inherit; font-size: 1rem; }
        .cart-container { font-size: 1.5rem; position: relative; color: inherit; text-decoration: none; }
      ...
      <nav className="nav">
        <Link href="/" className="logo-link">
          ...
          <span className="logo-text">{siteSettings?.site_name || 'Kalamkar'}</span>
        </Link>
